              ...
              <table className='min-w-full table-auto border-collapse'>
                <thead className='bg-gray-100'>
                  <tr>
                    ...
                    <th className='px-4 py-4 text-sm font-semibold text-black text-left'>
                      Judul
                    </th>
                    <th className='px-4 py-4 text-sm font-semibold text-black text-center'>
                      Kategori
                ...
                <tbody>
                  {currentItems.map((item, index) => (
                    <tr key={item.id} className='border-b'>
                      ...
                      <td className='px-4 py-6 text-center text-sm text-black'>
                        {item.tanggal}
                      </td>
                      <td className='px-4 py-6 text-center text-sm text-black'>
                        {item.gambar}
                      </td>
                      <td className='px-4 py-6 text-left text-sm text-black'>
                        {item.detail}
                      </td>
                      <td className='px-4 py-6 text-center'>
                        <span
